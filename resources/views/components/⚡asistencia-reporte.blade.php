...
new class extends Component {
    ...
    public function with(): array
    {
        ...
        $reporteAulas = DB::table('personas')->select('aula', DB::raw('count(*) as esperados'), DB::raw('(SELECT count(*) FROM asistencias WHERE asistencias.aula = personas.aula) as registrados'))->groupBy('aula')->orderBy('aula', 'asc')->get();
...
<div class="bg-gray-100 min-h-screen p-8 font-sans">
    <div class="max-w-6xl mx-auto">
        <div class="border-b-2 border-blue-900 mb-8 pb-4">
            <h1 class="text-3xl font-light text-gray-800 uppercase tracking-wide">Control de Asistencia</h1>
        </div>
