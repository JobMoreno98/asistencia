...
<div class="bg-gray-100 min-h-screen p-8 font-sans">
    <div class="max-w-6xl mx-auto">
        <div class="border-b-2 border-blue-900 mb-8 pb-4">
            <h1 class="text-3xl font-light text-gray-800 uppercase tracking-wide">Control de Asistencia Institucional</h1>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center justify-center">
                                        ...
                                        <span class="text-xs font-medium text-gray-700">{{ number_format($porcentaje, 1) }}%</span>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
